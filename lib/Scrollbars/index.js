...
var _isScrollbarRequired = require('../utils/isScrollbarRequired');
...
var Scrollbars = function (_Component) {
    ...
    _createClass(Scrollbars, [{
        ...
        value: function handleHorizontalTrackMouseDown(event) {
            ...
            var thumbWidth = this.getThumbHorizontalWidth();
            var X = touches ? touches[0].clientX : clientX;
            var offset = Math.abs(targetLeft - X) - thumbWidth / 2;
        ...
        value: function handleVerticalTrackMouseDown(event) {
            ...
            var thumbHeight = this.getThumbVerticalHeight();
            var Y = touches ? touches[0].clientY : clientY;
            var offset = Math.abs(targetTop - Y) - thumbHeight / 2;
        ...
        value: function handleDrag(event) {
            if (this.prevPageX) {
                ...
                var X = touches ? touches[0].clientX : clientX;
                var offset = -trackLeft + X - clickPosition;
                this.view.scrollLeft = this.getScrollLeftForOffset(offset);
            }
            if (this.prevPageY) {
                ...
                var Y = _touches ? _touches[0].clientY : clientY;
                var _offset = -trackTop + Y - _clickPosition;
        ...
        value: function render() {
            ...
            var baseViewStyle = (0, _isScrollbarRequired2.default)() ? _styles.viewStyleDefault : _styles.viewStyleMobile;
